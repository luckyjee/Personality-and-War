...
names(endcols2) = c("end_choice","scale","increase_choice","spending","casualties","interest","personal_reputation","public","US_reputation","end_selected", "task_profile_end","increase_selected")
names(endcols3) = c("end_choice","scale","increase_choice","spending","casualties","interest","personal_reputation","public","US_reputation","end_selected","task_profile_end","increase_selected")
names(endcols4) = c("end_choice","scale","increase_choice","spending","casualties","interest","personal_reputation","public","US_reputation","end_selected","task_profile_end","increase_selected")
names(endcols5) = c("end_choice","scale","increase_choice","spending","casualties","interest","personal_reputation","public","US_reputation","end_selected","task_profile_end","increase_selected")
names(endcols6) = c("end_choice","scale","increase_choice","spending","casualties","interest","personal_reputation","public","US_reputation","end_selected","task_profile_end","increase_selected")
