...
## For later diagnostic tests - variables 10
startcols1$task_profile <- "1"
startcols2$task_profile <- "2"
startcols3$task_profile <- "3"
startcols4$task_profile <- "4"
startcols5$task_profile <- "5"
startcols6$task_profile <- "6"

## Standardize Names
names(startcols1) = c("choice","scale","strength","casualties","interest","economy","public","reputation","selected","task_profile_start")
names(startcols2) = c("choice","scale","strength","casualties","interest","economy","public","reputation","selected","task_profile_start")
names(startcols3) = c("choice","scale","strength","casualties","interest","economy","public","reputation","selected","task_profile_start")
names(startcols4) = c("choice","scale","strength","casualties","interest","economy","public","reputation","selected","task_profile_start")
names(startcols5) = c("choice","scale","strength","casualties","interest","economy","public","reputation","selected","task_profile_start")
names(startcols6) = c("choice","scale","strength","casualties","interest","economy","public","reputation","selected","task_profile_start")
