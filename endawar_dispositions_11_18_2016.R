##############
## 11-20-2016
## Tried with clustered SE for Extraversion and Neuroticism, but the results are not as stark. 
...
end_exthi_mod$clse<-cluster.vcov(end_exthi_mod,end_stack[end_stack$extraversionHi==1,]$resp_id)
seh<-coeftest(end_exthi_mod, end_exthi_mod$clse)
seh

seh_vars=variable.names(end_exthi_mod)
seh_coefs = c(seh[,1])
seh_err = c(seh[,2]*1.96)
seh_tvals = c(e[,4])
seh_tmp = data.frame(cbind(seh_coefs,seh_err))


## select particular coefficients
end_exthi_tmp2=seh_tmp
end_exthi_tmp2$name = row.names(end_exthi_tmp2)
end_exthi_tmp2 = end_exthi_tmp2[,c("name","seh_coefs","seh_err")]
...
end_extlo_mod$clse<-cluster.vcov(end_extlo_mod,end_stack[end_stack$extraversionLo==1,]$resp_id)
seh<-coeftest(end_extlo_mod, end_extlo_mod$clse)
seh

seh_vars=variable.names(end_extlo_mod)
seh_coefs = c(seh[,1])
seh_err = c(seh[,2]*1.96)
seh_tvals = c(e[,4])
seh_tmp = data.frame(cbind(seh_coefs,seh_err))
...
## select particular coefficients
end_extlo_tmp2=seh_tmp
end_extlo_tmp2$name = row.names(end_extlo_tmp2)
end_extlo_tmp2 = end_extlo_tmp2[,c("name","seh_coefs","seh_err")]
...
end_neuhi_mod$clse<-cluster.vcov(end_neuhi_mod,end_stack[end_stack$neuroticismHi==1,]$resp_id)
seh<-coeftest(end_neuhi_mod, end_neuhi_mod$clse)
seh

seh_vars=variable.names(end_neuhi_mod)
seh_coefs = c(seh[,1])
seh_err = c(seh[,2]*1.96)
seh_tvals = c(e[,4])
seh_tmp = data.frame(cbind(seh_coefs,seh_err))
...
## select particular coefficients
end_neuhi_tmp2=seh_tmp
end_neuhi_tmp2$name = row.names(end_neuhi_tmp2)
end_neuhi_tmp2 = end_neuhi_tmp2[,c("name","seh_coefs","seh_err")]
...
end_neulo_mod$clse<-cluster.vcov(end_neulo_mod,end_stack[end_stack$neuroticismLo==1,]$resp_id)
seh<-coeftest(end_neulo_mod, end_neulo_mod$clse)
seh

seh_vars=variable.names(end_neulo_mod)
seh_coefs = c(seh[,1])
seh_err = c(seh[,2]*1.96)
seh_tvals = c(e[,4])
seh_tmp = data.frame(cbind(seh_coefs,seh_err))
...
## select particular coefficients
end_neulo_tmp2=seh_tmp
end_neulo_tmp2$name = row.names(end_neulo_tmp2)
end_neulo_tmp2 = end_neulo_tmp2[,c("name","seh_coefs","seh_err")]
